...
from ...new_models.events.abilities import (
    cast_reactive_armor, expire_reactive_armor
)
...
class CHArmor(
    ...
    def __init__(self, **kwargs):
        ...
        self.bind(
            base_armor=self.armor_rating_updated,
            current_armor=self.armor_rating_updated
        )
